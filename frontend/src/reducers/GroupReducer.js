...
export const createGroup = (payload) => async (dispatch, getState) => {
  ...
  await axios
    .post(
      "http://54.153.78.74:3010/createGroup",
...
export const getInviteInfo = (payload) => async (dispatch, getState) => {
  ...
  await axios
    .get("http://54.153.78.74:3010/mygroups", {
...
export const getGroupInfo = (payload) => async (dispatch, getState) => {
  ...
  const userId = localStorage.getItem("userId")
  await axios
    .post("http://54.153.78.74:3010/mygroups", { userId: payload.userId?payload.userId:userId }, {headers: {
      'Authorization': token,
    }})
    .then((res) => {
      if (res.status === 201) {
...
export const groupRejection = (payload) => async (dispatch, getState) => {
  ...
  console.log(payload);
  await axios
    .post("http://54.153.78.74:3010/rejInvStatus", { rejectedGroup, userId }, {headers: {
      'Authorization': token,
    }})
    .then((response) => {
...
export const groupAcception = (payload) => async (dispatch, getState) => {
  ...
  const token = localStorage.getItem("id_token");
  await axios
    .post("http://54.153.78.74:3010/accInvStatus", { acceptedGroup, userId },{headers: {
      'Authorization': token,
    }})
    .then((response) => {
      if (response.status === 269) {
